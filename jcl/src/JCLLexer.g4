...
OUTPUT_STMT_DEFAULT : D E F A U L T ->pushMode(OUTPUT_DEFAULT_MODE) ;
...
OUTPUT_ADDRESS_SQUOTE : '\'' ->channel(HIDDEN),pushMode(QS) ;
...
OUTPUT_BUILDING_SQUOTE : '\'' ->channel(HIDDEN),pushMode(QS) ;
