...
OUTPUT_PARM_PAREN_WS : [ ]+ ->channel(HIDDEN),mode(OUTPUT_PARM_PAREN_MODE_CM) ;
OUTPUT_PARM_PAREN_NEWLINE : [\n\r] ->channel(HIDDEN),mode(OUTPUT_PARM_PAREN_CONT_MODE) ;
OUTPUT_PARM_PAREN_RPAREN : RPAREN_DFLT ->type(RPAREN),mode(DEFAULT_MODE) ;

mode OUTPUT_PARM_PAREN_MODE_CM ;

OUTPUT_PARM_PAREN_MODE_CM_NEWLINE : NEWLINE ->channel(HIDDEN),mode(OUTPUT_PARM_PAREN_CONT_MODE) ;
OUTPUT_PARM_PAREN_MODE_CM_COMMENT_TEXT : (' ' | ANYCHAR)+ ->type(COMMENT_TEXT) ;

mode OUTPUT_PARM_PAREN_CONT_MODE ;

OUTPUT_PARM_PAREN_CONT_MODE_SS : SS ->channel(HIDDEN) ;
OUTPUT_PARM_PAREN_CONT_MODE_COMMENT_FLAG : COMMENT_FLAG_DFLT ->type(COMMENT_FLAG),mode(OUTPUT_PARM_PAREN_CONT_MODE_CM) ;
OUTPUT_PARM_PAREN_CONT_MODE_CONTINUATION_WS : CONTINUATION_WS ->channel(HIDDEN),mode(OUTPUT_PARM_PAREN_MODE) ;

mode OUTPUT_PARM_PAREN_CONT_MODE_CM ;

OUTPUT_PARM_PAREN_CONT_MODE_CM_NEWLINE : NEWLINE ->channel(HIDDEN),mode(OUTPUT_PARM_PAREN_CONT_MODE) ;
OUTPUT_PARM_PAREN_CONT_MODE_CM_COMMENT_TEXT : (' ' | ANYCHAR)+ ->type(COMMENT_TEXT) ;
...
PATHMODE_PAREN_WS : [ ]+ ->channel(HIDDEN),mode(PATHMODE_PAREN_MODE_CM) ;
PATHMODE_PAREN_NEWLINE : NEWLINE ->channel(HIDDEN),mode(PATHMODE_PAREN_CONT_MODE) ;
...
mode PATHMODE_PAREN_MODE_CM ;

PATHMODE_PAREN_MODE_CM_NEWLINE : NEWLINE ->channel(HIDDEN),mode(PATHMODE_PAREN_CONT_MODE) ;
PATHMODE_PAREN_MODE_CM_COMMENT_TEXT : (' ' | ANYCHAR)+ ->type(COMMENT_TEXT) ;

mode PATHMODE_PAREN_CONT_MODE ;

PATHMODE_PAREN_CONT_MODE_SS : SS ->channel(HIDDEN) ;
PATHMODE_PAREN_CONT_MODE_COMMENT_FLAG : COMMENT_FLAG_DFLT ->type(COMMENT_FLAG),mode(PATHMODE_PAREN_CONT_MODE_CM) ;
PATHMODE_PAREN_CONT_MODE_CONTINUATION_WS : CONTINUATION_WS ->channel(HIDDEN),mode(PATHMODE_PAREN_MODE) ;

mode PATHMODE_PAREN_CONT_MODE_CM ;

PATHMODE_PAREN_CONT_MODE_CM_NEWLINE : NEWLINE ->channel(HIDDEN),mode(PATHMODE_PAREN_CONT_MODE) ;
PATHMODE_PAREN_CONT_MODE_CM_COMMENT_TEXT : (' ' | ANYCHAR)+ ->type(COMMENT_TEXT) ;
...
PATHOPTS_PAREN_WS : [ ]+ ->channel(HIDDEN),mode(PATHOPTS_PAREN_MODE_CM) ;
PATHOPTS_PAREN_NEWLINE : NEWLINE ->channel(HIDDEN),mode(PATHOPTS_PAREN_CONT_MODE) ;
...
mode PATHOPTS_PAREN_MODE_CM ;

PATHOPTS_PAREN_MODE_CM_NEWLINE : NEWLINE ->channel(HIDDEN),mode(PATHOPTS_PAREN_CONT_MODE) ;
PATHOPTS_PAREN_MODE_CM_COMMENT_TEXT : (' ' | ANYCHAR)+ ->type(COMMENT_TEXT) ;

mode PATHOPTS_PAREN_CONT_MODE ;

PATHOPTS_PAREN_CONT_MODE_SS : SS ->channel(HIDDEN) ;
PATHOPTS_PAREN_CONT_MODE_COMMENT_FLAG : COMMENT_FLAG_DFLT ->type(COMMENT_FLAG),mode(PATHOPTS_PAREN_CONT_MODE_CM) ;
PATHOPTS_PAREN_CONT_MODE_CONTINUATION_WS : CONTINUATION_WS ->channel(HIDDEN),mode(PATHOPTS_PAREN_MODE) ;

mode PATHOPTS_PAREN_CONT_MODE_CM ;

PATHOPTS_PAREN_CONT_MODE_CM_NEWLINE : NEWLINE ->channel(HIDDEN),mode(PATHOPTS_PAREN_CONT_MODE) ;
PATHOPTS_PAREN_CONT_MODE_CM_COMMENT_TEXT : (' ' | ANYCHAR)+ ->type(COMMENT_TEXT) ;
...
SUBSYS_PAREN_WS : [ ]+ ->channel(HIDDEN),mode(SUBSYS_PAREN_MODE_CM) ;
...
mode SUBSYS_PAREN_MODE_CM ;

SUBSYS_PAREN_MODE_CM_NEWLINE : NEWLINE ->channel(HIDDEN),mode(SUBSYS_PAREN_CONT_MODE) ;
SUBSYS_PAREN_MODE_CM_COMMENT_TEXT : (' ' | ANYCHAR)+ ->type(COMMENT_TEXT) ;

mode SUBSYS_PAREN_CONT_MODE ;

SUBSYS_PAREN_CONT_MODE_SS : SS ->channel(HIDDEN) ;
SUBSYS_PAREN_CONT_MODE_COMMENT_FLAG : COMMENT_FLAG_DFLT ->type(COMMENT_FLAG),mode(SUBSYS_PAREN_CONT_MODE_CM) ;
SUBSYS_PAREN_CONT_MODE_CONTINUATION_WS : CONTINUATION_WS ->channel(HIDDEN),mode(SUBSYS_PAREN_MODE) ;

mode SUBSYS_PAREN_CONT_MODE_CM ;

SUBSYS_PAREN_CONT_MODE_CM_NEWLINE : NEWLINE ->channel(HIDDEN),mode(SUBSYS_PAREN_CONT_MODE) ;
SUBSYS_PAREN_CONT_MODE_CM_COMMENT_TEXT : (' ' | ANYCHAR)+ ->type(COMMENT_TEXT) ;

mode SUBSYS_COMMA_MODE ;

SUBSYS_COMMA_WS : [ ]+ ->channel(HIDDEN),mode(SUBSYS_COMMA_MODE_CM) ;
...
mode SUBSYS_COMMA_MODE_CM ;

SUBSYS_COMMA_MODE_CM_NEWLINE : NEWLINE ->channel(HIDDEN),mode(SUBSYS_COMMA_CONT_MODE) ;
SUBSYS_COMMA_MODE_CM_COMMENT_TEXT : (' ' | ANYCHAR)+ ->type(COMMENT_TEXT) ;

mode SUBSYS_COMMA_CONT_MODE ;

SUBSYS_COMMA_CONT_MODE_SS : SS ->channel(HIDDEN) ;
SUBSYS_COMMA_CONT_MODE_COMMENT_FLAG : COMMENT_FLAG_DFLT ->type(COMMENT_FLAG),mode(SUBSYS_COMMA_CONT_MODE_CM) ;
SUBSYS_COMMA_CONT_MODE_CONTINUATION_WS : CONTINUATION_WS ->channel(HIDDEN),mode(SUBSYS_COMMA_MODE) ;

mode SUBSYS_COMMA_CONT_MODE_CM ;

SUBSYS_COMMA_CONT_MODE_CM_NEWLINE : NEWLINE ->channel(HIDDEN),mode(SUBSYS_COMMA_CONT_MODE) ;
SUBSYS_COMMA_CONT_MODE_CM_COMMENT_TEXT : (' ' | ANYCHAR)+ ->type(COMMENT_TEXT) ;
