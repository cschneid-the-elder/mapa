...
DCB_MODE_DCB_EROPT : EROPT_DFLT ->type(EROPT),mode(DEFAULT_MODE) ;
...
DSNTYPE_BASIC : B A S I C ;
DSNTYPE_EXTPREF : E X T P R E F ;
DSNTYPE_EXTREQ : E X T R E Q ;
DSNTYPE_HFS : H F S ;
DSNTYPE_LARGE : L A R G E ;
DSNTYPE_LIBRARY : L I B R A R Y ;
DSNTYPE_PDS : P D S ;
DSNTYPE_PIPE : P I P E ;
