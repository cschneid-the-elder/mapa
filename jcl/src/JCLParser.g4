...
jobParmJOBRC : JOBRC EQUAL (MAXRC | LASTRC | (LPAREN STEP COMMA JOBRC_STEP RPAREN)) ;
...
jobParmREGION : REGION EQUAL ((NUM_LIT MEM_UNIT) | ALNUMNAT) ;

jobParmREGIONX : REGIONX EQUAL LPAREN? ((NUM_LIT MEM_UNIT) | ALNUMNAT) (COMMA ((NUM_LIT MEM_UNIT) | ALNUMNAT)) RPAREN? ;
