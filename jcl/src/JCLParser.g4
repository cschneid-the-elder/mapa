...
outputStatementADDRESS : OUTPUT_STMT_ADDRESS EQUAL (
    ...
    QUOTED_STRING_FRAGMENT
  ;
outputStatementAFPPARMS : OUTPUT_STMT_AFPPARMS EQUAL (DATASET_NAME | QUOTED_STRING_FRAGMENT) ;
outputStatementAFPSTATS : OUTPUT_STMT_AFPSTATS EQUAL yesOrNo ;
outputStatementBUILDING : OUTPUT_STMT_BUILDING EQUAL QUOTED_STRING_FRAGMENT ;
outputStatementBURST : OUTPUT_STMT_BURST EQUAL yesOrNo ;
outputStatementCHARS : OUTPUT_STMT_CHARS EQUAL (
    ...
    DUMP
  ;
outputStatementCKPTLINE : OUTPUT_STMT_CKPTLINE EQUAL NUM_LIT ;
outputStatementCKPTPAGE : OUTPUT_STMT_CKPTPAGE EQUAL NUM_LIT ;
outputStatementCKPTSEC : OUTPUT_STMT_CKPTSEC EQUAL NUM_LIT ;
outputStatementCLASS : OUTPUT_STMT_CLASS EQUAL (OUTPUT_CLASS_VALUE | SYMBOLIC | QUOTED_STRING_FRAGMENT) ;
outputStatementCOLORMAP : OUTPUT_STMT_COLORMAP EQUAL ALNUMNAT ;
outputStatementCOMPACT : OUTPUT_STMT_COMPACT EQUAL ALNUMNAT ;
outputStatementCOMSETUP : OUTPUT_STMT_COMSETUP EQUAL ALNUMNAT ;
outputStatementCONTROL : OUTPUT_STMT_CONTROL EQUAL (PROGRAM | SINGLE | DOUBLE | TRIPLE) ;
outputStatementCOPIES : OUTPUT_STMT_COPIES EQUAL (
    ...
    NUM_LIT
  ;
outputStatementCOPYCNT : OUTPUT_STMT_COPYCNT EQUAL NUM_LIT ;
outputStatementDATACK : OUTPUT_STMT_DATACK EQUAL (BLOCK | UNBLOCK | BLKCHAR | BLKPOS) ;
outputStatementDDNAME : OUTPUT_STMT_DDNAME EQUAL NAME (DOT NAME)? (DOT NAME)? ;
outputStatementDEFAULT : OUTPUT_STMT_DEFAULT EQUAL OUTPUT_DEFAULT_VALUE ;
