...
ddParmDEST : DEST EQUAL (LOCAL | ANYLOCAL | SYMBOLIC | ALPHA+ | ALNUMNAT | NAME | NUM_LIT) ;
...
ddParmEROPT : EROPT EQUAL (NAME | SYMBOLIC) ;
...
ddParmFLASH : FLASH EQUAL (ALNUMNAT | NONE | (ALNUMNAT (COMMA (NUM_LIT | SYMBOLIC))?)) ;
...
ddParmLRECL : LRECL EQUAL (NUM_LIT | NUM_MEM_VAL | ALPHA | SYMBOLIC) ;
ddParmMAXGENS : MAXGENS EQUAL (NUM_LIT | SYMBOLIC) ;
ddParmMGMTCLAS : MGMTCLAS EQUAL NAME? ;
ddParmMODE : MODE EQUAL MODE_PARMS ; 
ddParmMODIFY : MODIFY EQUAL LPAREN? NAME (COMMA (NUM_LIT | SYMBOLIC))? RPAREN? ;
ddParmNCP : NCP EQUAL (NUM_LIT | SYMBOLIC) ;
ddParmNTM : NTM EQUAL (NUM_LIT | SYMBOLIC) ;
ddParmOPTCD : OPTCD EQUAL (ALPHA+ | SYMBOLIC) ;
...
ddParmRECFM : RECFM EQUAL NAME ;
ddParmRECORG : RECORG EQUAL (ALPHA+ | SYMBOLIC) ;
...
ddParmSPIN : SPIN EQUAL (
    ...
    (LPAREN UNALLOC COMMA ((NUM_LIT | SYMBOLIC) (K | M)?) RPAREN) |
...
ddParmSTORCLAS : STORCLAS EQUAL STORCLAS_VALUE? ;
...
ddParmTRTCH : TRTCH EQUAL (ALPHA+ | SYMBOLIC) ;
ddParmUCS : UCS EQUAL (
    ALNUMNAT |
