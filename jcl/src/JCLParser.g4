...
ddParmBFTEK : BFTEK EQUAL (KEYWORD_VALUE | SYMBOLIC) ;
//ddParmBLKSIZE : BLKSIZE EQUAL (NUM_LIT | NUM_MEM_VAL | SYMBOLIC) ;
ddParmBLKSIZE : BLKSIZE EQUAL (KEYWORD_VALUE | SYMBOLIC) ;
//ddParmBLKSZLIM : BLKSZLIM EQUAL (NUM_LIT | NUM_MEM_VAL | SYMBOLIC) ;
ddParmBLKSZLIM : BLKSZLIM EQUAL (KEYWORD_VALUE | SYMBOLIC) ;
...
ddParmBURST : BURST EQUAL (KEYWORD_VALUE | SYMBOLIC) ;
ddParmCCSID : CCSID EQUAL (KEYWORD_VALUE | SYMBOLIC) ;
...
ddParmCPRI : CPRI EQUAL (KEYWORD_VALUE | SYMBOLIC) ;
//ddParmCYLOFL : CYLOFL EQUAL (NUM_LIT | SYMBOLIC) ;
ddParmCYLOFL : CYLOFL EQUAL (KEYWORD_VALUE | SYMBOLIC) ;
ddParmDATA : DATA ;
...
ddParmDEN : DEN EQUAL (KEYWORD_VALUE | SYMBOLIC) ;
...
ddParmFREE : FREE EQUAL (KEYWORD_VALUE | SYMBOLIC) ;
ddParmFREEVOL : FREEVOL EQUAL (KEYWORD_VALUE | SYMBOLIC) ;
ddParmFUNC : FUNC EQUAL (FUNC_VALUE | SYMBOLIC) ;
ddParmGDGORDER : GDGORDER EQUAL (KEYWORD_VALUE | SYMBOLIC) ;
//ddParmGNCP : GNCP EQUAL (NUM_LIT | SYMBOLIC) ;
ddParmGNCP : GNCP EQUAL (KEYWORD_VALUE | SYMBOLIC) ;
...
ddParmINTVL : INTVL EQUAL (KEYWORD_VALUE | SYMBOLIC) ;
ddParmIPLTXID : IPLTXID EQUAL (KEYWORD_VALUE | SYMBOLIC) ;
...
ddParmKEYLEN : KEYLEN EQUAL (KEYWORD_VALUE | SYMBOLIC) ;
ddParmKEYOFF : KEYOFF EQUAL (KEYWORD_VALUE | SYMBOLIC) ;
...
ddParmLIMCT: LIMCT EQUAL (KEYWORD_VALUE | SYMBOLIC) ;
ddParmLRECL : LRECL EQUAL (LRECL_VALUE | SYMBOLIC) ;
//ddParmMAXGENS : MAXGENS EQUAL (NUM_LIT | SYMBOLIC) ;
ddParmMAXGENS : MAXGENS EQUAL (KEYWORD_VALUE | SYMBOLIC) ;
ddParmMGMTCLAS : MGMTCLAS EQUAL (KEYWORD_VALUE | SYMBOLIC)? ;
...
ddParmNCP : NCP EQUAL (KEYWORD_VALUE | SYMBOLIC) ;
ddParmNTM : NTM EQUAL (KEYWORD_VALUE | SYMBOLIC) ;
ddParmOPTCD : OPTCD EQUAL (OPTCD_VALUE | SYMBOLIC) ;
//ddParmOUTLIM : OUTLIM EQUAL (NUM_LIT | SYMBOLIC) ;
ddParmOUTLIM : OUTLIM EQUAL (KEYWORD_VALUE | SYMBOLIC) ;
...
ddParmPRTSP : PRTSP EQUAL (KEYWORD_VALUE | SYMBOLIC) ;
...
ddParmRESERVE : RESERVE EQUAL LPAREN (KEYWORD_VALUE | SYMBOLIC) COMMA (KEYWORD_VALUE | SYMBOLIC) RPAREN ;
ddParmRETPD : RETPD EQUAL (RETPD_VALUE | SYMBOLIC) ;
//ddParmRKP : RKP EQUAL (NUM_LIT | SYMBOLIC) ;
ddParmRKP : RKP EQUAL (KEYWORD_VALUE | SYMBOLIC) ;
...
ddParmSEGMENT : SEGMENT EQUAL (KEYWORD_VALUE | SYMBOLIC) ;
...
ddParmSPIN : SPIN EQUAL (
    ...
    (LPAREN KEYWORD_VALUE COMMA (KEYWORD_VALUE | SYMBOLIC) RPAREN) |
...
ddParmSTACK : STACK EQUAL (KEYWORD_VALUE | SYMBOLIC) ;
ddParmSTORCLAS : STORCLAS EQUAL (KEYWORD_VALUE | SYMBOLIC)? ;
...
ddParmTHRESH : THRESH EQUAL (KEYWORD_VALUE | SYMBOLIC) ;
...
outputStatementDDNAME : OUTPUT_STMT_DDNAME EQUAL NAME (DOT NAME)? (DOT NAME)? ;
outputStatementDEFAULT : OUTPUT_STMT_DEFAULT EQUAL (OUTPUT_DEFAULT_VALUE | SYMBOLIC) ;
outputStatementDEPT : OUTPUT_STMT_DEPT EQUAL (QUOTED_STRING_FRAGMENT | ALNUMNAT | ALPHA | NUM_LIT) ;
...
outputStatementDPAGELBL : OUTPUT_STMT_DPAGELBL EQUAL yesOrNo ;
outputStatementDUPLEX : OUTPUT_STMT_DUPLEX EQUAL (NO | N | NORMAL | TUMBLE) ;
outputStatementFCB : OUTPUT_STMT_FCB EQUAL ALNUMNAT ;
...
outputStatementFORMDEF : OUTPUT_STMT_FORMDEF EQUAL ALNUMNAT ;
outputStatementFORMLEN : OUTPUT_STMT_FORMLEN EQUAL NUM_LIT (DOT NUM_LIT)? (IN | CM_UNIT) ;
outputStatementFORMS : OUTPUT_STMT_FORMS EQUAL ALNUMNAT ;
outputStatementFSSDATA : OUTPUT_STMT_FSSDATA EQUAL (QUOTED_STRING_FRAGMENT | ALNUMNAT | SYMBOLIC) ;
outputStatementGROUPID : OUTPUT_STMT_GROUPID EQUAL ALNUMNAT ;
outputStatementINDEX : OUTPUT_STMT_INDEX EQUAL NUM_LIT ;
outputStatementINTRAY : OUTPUT_STMT_INTRAY EQUAL NUM_LIT ;
outputStatementJESDS : OUTPUT_STMT_JESDS EQUAL OUTPUT_JESDS_VALUE ;
outputStatementLINDEX : OUTPUT_STMT_LINDEX EQUAL NUM_LIT ;
outputStatementLINECT : OUTPUT_STMT_LINECT EQUAL NUM_LIT ;
...
outputStatementMAILCC : OUTPUT_STMT_MAILCC EQUAL ALNUMNAT | QUOTED_STRING_FRAGMENT |
    ...
    RPAREN)
  ;
outputStatementMAILFILE : OUTPUT_STMT_MAILFILE EQUAL QUOTED_STRING_FRAGMENT ;
outputStatementMAILFROM : OUTPUT_STMT_MAILFROM EQUAL QUOTED_STRING_FRAGMENT | ALNUMNAT ;
outputStatementMAILTO : OUTPUT_STMT_MAILTO EQUAL EQUAL ALNUMNAT | QUOTED_STRING_FRAGMENT |
    ...
    RPAREN)
  ;
outputStatementMERGE : OUTPUT_STMT_MERGE EQUAL yesOrNo ;
outputStatementMODIFY : OUTPUT_STMT_MODIFY EQUAL ALNUMNAT | (LPAREN ALNUMNAT (COMMA NUM_LIT)?) ;
outputStatementNAME : OUTPUT_STMT_NAME EQUAL ALNUMNAT | QUOTED_STRING_FRAGMENT ;
outputStatementNOTIFY : OUTPUT_STMT_NOTIFY EQUAL (NAME (DOT NAME)?) | 
    (LPAREN (NAME (DOT NAME)?) (COMMA (NAME (DOT NAME)?)+ RPAREN))
  ;
outputStatementOFFSETXB : OUTPUT_STMT_OFFSETXB EQUAL NUM_LIT (DOT NUM_LIT)? outputStatementOFFSET_unit ;
outputStatementOFFSETXF : OUTPUT_STMT_OFFSETXF EQUAL NUM_LIT (DOT NUM_LIT)? outputStatementOFFSET_unit ;
outputStatementOFFSETYB : OUTPUT_STMT_OFFSETYB EQUAL NUM_LIT (DOT NUM_LIT)? outputStatementOFFSET_unit ;
outputStatementOFFSETYF : OUTPUT_STMT_OFFSETYF EQUAL NUM_LIT (DOT NUM_LIT)? outputStatementOFFSET_unit ;
outputStatementOFFSET_unit : IN | CM_UNIT | MM | PELS | POINTS ;
outputStatementOUTBIN : OUTPUT_STMT_OUTBIN EQUAL NUM_LIT ;
outputStatementOUTDISP : OUTPUT_STMT_OUTDISP EQUAL outputStatementOUTDISP_val | 
...
outputStatementOVERLAYB : OUTPUT_STMT_OVERLAYB EQUAL NAME ;
outputStatementOVERLAYF : OUTPUT_STMT_OVERLAYF EQUAL NAME ;
outputStatementOVFL : OUTPUT_STMT_OVFL EQUAL (ON | OFF) ;
outputStatementPAGEDEF : OUTPUT_STMT_PAGEDEF EQUAL NAME ;
outputStatementPIMSG : OUTPUT_STMT_PIMSG EQUAL yesOrNo | 
    (LPAREN yesOrNo (COMMA NUM_LIT)? RPAREN)
  ;
outputStatementPORTNO : OUTPUT_STMT_PORTNO EQUAL NUM_LIT ;
outputStatementPRMODE : OUTPUT_STMT_PRMODE EQUAL NAME ;
outputStatementPRTATTRS : OUTPUT_STMT_PRTATTRS EQUAL QUOTED_STRING_FRAGMENT ;
outputStatementPRTERROR : OUTPUT_STMT_PRTERROR EQUAL DEFAULT | QUIT | HOLD ;
outputStatementPRTOPTNS : OUTPUT_STMT_PRTOPTNS EQUAL QUOTED_STRING_FRAGMENT | ALNUMNAT ;
outputStatementPRTQUEUE : OUTPUT_STMT_PRTQUEUE EQUAL QUOTED_STRING_FRAGMENT | ALNUMNAT ;
outputStatementPRTY : OUTPUT_STMT_PRTY EQUAL NUM_LIT ;
outputStatementREPLYTO : OUTPUT_STMT_REPLYTO EQUAL QUOTED_STRING_FRAGMENT | ALNUMNAT ;
outputStatementRESFMT : OUTPUT_STMT_RESFMT EQUAL NAME ;
outputStatementRETAINS : OUTPUT_STMT_RETAINS EQUAL QUOTED_STRING_FRAGMENT | FOREVER ;
outputStatementRETAINF : OUTPUT_STMT_RETAINF EQUAL QUOTED_STRING_FRAGMENT | FOREVER ;
outputStatementRETRYL : OUTPUT_STMT_RETRYL EQUAL NUM_LIT ;
outputStatementRETRYT : OUTPUT_STMT_RETRYT EQUAL QUOTED_STRING_FRAGMENT ;
outputStatementROOM : OUTPUT_STMT_ROOM EQUAL QUOTED_STRING_FRAGMENT | ALNUMNAT ;
outputStatementSYSAREA : OUTPUT_STMT_SYSAREA EQUAL yesOrNo ;
outputStatementTHRESHLD : OUTPUT_STMT_THRESHLD EQUAL NUM_LIT ;
outputStatementTITLE : OUTPUT_STMT_TITLE EQUAL QUOTED_STRING_FRAGMENT | ALNUMNAT ;
outputStatementTRC : OUTPUT_STMT_TRC EQUAL yesOrNo ;
outputStatementUCS : OUTPUT_STMT_UCS EQUAL NAME ;
outputStatementUSERDATA : OUTPUT_STMT_USERDATA EQUAL QUOTED_STRING_FRAGMENT | ALNUMNAT |
    (LPAREN 
        (ALNUMNAT | QUOTED_STRING_FRAGMENT) 
            ((COMMA | inlineComment)? SS? (ALNUMNAT | QUOTED_STRING_FRAGMENT))*
    RPAREN)
