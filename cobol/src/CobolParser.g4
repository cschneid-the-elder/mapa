...
/*
pictureChars
   : DOLLARCHAR | IDENTIFIER | NUMERICLITERAL | SLASHCHAR | COMMACHAR | DOT | ASTERISKCHAR | DOUBLEASTERISKCHAR | PLUSCHAR | MINUSCHAR | integerLiteral
   ;
*/
pictureCardinality
   : PICTURE_CARDINALITY
...
freeFormText
   : TEXTA+ | literal | IDENTIFIER | ABORT | ACCEPT | ACCESS | ADD | ADDRESS | ADVANCING | AFTER | ALIGNED | ALL | ALPHABET | ALPHABETIC | ALPHABETIC_LOWER | ALPHABETIC_UPPER | ALPHANUMERIC | ALPHANUMERIC_EDITED | ALSO | ALTER | ALTERNATE | AND | ANY | ARE | AREA | AREAS | AS | ASCENDING | ASCII | ASSIGN | ASSOCIATED_DATA | ASSOCIATED_DATA_LENGTH | AT | ATTRIBUTE | AUTHOR | AUTO | AUTO_SKIP | BACKGROUND_COLOR | BACKGROUND_COLOUR | BASIS | BEEP | BEFORE | BEGINNING | BELL | BINARY | BIT | BLANK | BLINK | BLOB | BLOCK | BOUNDS | BOTTOM | BY | BYFUNCTION | BYTITLE | CALL | CANCEL | CAPABLE | CCSVERSION | CD | CF | CH | CHAINING | CHANGED | CHANNEL | CHARACTER | CHARACTERS | CICS | CLASS | CLASS_ID | CLOB | CLOCK_UNITS | CLOSE | CLOSE_DISPOSITION | COBOL | CODE | CODE_SET | COLLATING | COL | COLUMN | COM_REG | COMMA | COMMITMENT | COMMON | COMMUNICATION | COMP | COMP_1 | COMP_2 | COMP_3 | COMP_4 | COMP_5 | COMPUTATIONAL | COMPUTATIONAL_1 | COMPUTATIONAL_2 | COMPUTATIONAL_3 | COMPUTATIONAL_4 | COMPUTATIONAL_5 | COMPUTE | CONFIGURATION | CONTAINS | CONTENT | CONTINUE | CONTROL | CONTROL_POINT | CONTROLS | CONVENTION | CONVERTING | COPY | CORR | CORRESPONDING | COUNT | CRUNCH | CURRENCY | CURSOR | DATA | DATA_BASE | DATE | DATE_COMPILED | DATE_WRITTEN | DAY | DAY_OF_WEEK | DBCS | DBCLOB | DE | DEBUG_CONTENTS | DEBUG_ITEM | DEBUG_LINE | DEBUG_NAME | DEBUG_SUB_1 | DEBUG_SUB_2 | DEBUG_SUB_3 | DEBUGGING | DECIMAL_POINT | DECLARATIVES | DEFAULT | DEFAULT_DISPLAY | DEFINITION | DELETE | DELIMITED | DELIMITER | DEPENDING | DESCENDING | DESTINATION | DETAIL | DFHRESP | DFHVALUE | DISABLE | DISK | DISPLAY | DISPLAY_1 | DIVIDE | DIVISION | DONTCARE | DOUBLE | DOWN | DUPLICATES | DYNAMIC | EBCDIC | EGCS |  
EGI | EJECT | ELSE | EMI | EMPTY_CHECK | ENABLE | END | END_ACCEPT | END_ADD | END_CALL | END_COMPUTE | END_DELETE | END_DISPLAY | END_DIVIDE | END_EVALUATE | END_EXEC | END_IF | END_MULTIPLY | END_OF_PAGE | END_PERFORM | END_READ | END_RECEIVE | END_REMARKS | END_RETURN | END_REWRITE | END_SEARCH | END_START | END_STRING | END_SUBTRACT | END_UNSTRING | END_WRITE | ENDING | ENTER | ENTRY | ENTRY_PROCEDURE | ENVIRONMENT | EOP | EQUAL | ERASE | ERROR | EOL | EOS | ESCAPE | ESI | EVALUATE | EVENT | EVERY | EXCEPTION | EXCLUSIVE | EXEC | EXHIBIT | EXIT | EXPORT | EXTEND | EXTENDED | EXTERNAL | FALSE | FD | FILE | FILE_CONTROL | FILLER | FINAL | FIRST | FOOTING | FOR | FOREGROUND_COLOR | FOREGROUND_COLOUR | FROM | FULL | FUNCTION | FUNCTIONNAME | FUNCTION_POINTER | GENERATE | GOBACK | GIVING | GLOBAL | GO | GREATER | GRID | GROUP | HEADING | HIGHLIGHT | HIGH_VALUE | HIGH_VALUES | I_O | I_O_CONTROL | ID | IDENTIFICATION | IF | IMPLICIT | IMPORT | IN | INDEX | INDEXED | INDICATE | INITIAL | INITIALIZE | INITIATE | INPUT | INPUT_OUTPUT | INSPECT | INSTALLATION | INTEGER | INTO | INVALID | INVOKE | IS | JUST | JUSTIFIED | KANJI | KEPT | KEY | KEYBOARD | LABEL | LANGUAGE | LAST | LB | LD | LEADING | LEFT | LEFTLINE | LENGTH | LENGTH_CHECK | LESS | LIBACCESS | LIBPARAMETER | LIBRARY | LIMIT | LIMITS | LINAGE | LINAGE_COUNTER | LINE | LINES | LINE_COUNTER | LINK | LINKAGE | LIST | LOCAL | LOCAL_STORAGE | LOCK | LONG_DATE | LONG_TIME | LOWER | LOWLIGHT | LOW_VALUE | LOW_VALUES | MEMORY | MERGE | MESSAGE | MMDDYYYY | MODE | MODULES | MORE_LABELS | MOVE | MULTIPLE | MULTIPLY | NAMED | NATIONAL | NATIONAL_EDITED | NATIVE | NEGATIVE | NETWORK | NEXT | NO | NO_ECHO | NOT | NULL | NULLS | NUMBER | NUMERIC | NUMERIC_DATE | NUMERIC_EDITED | NUMERIC_TIME | OBJECT_COMPUTER | OCCURS | ODT | OF | OFF | OMITTED | ON | OPEN | OPTIONAL | OR | ORDER | ORDERLY | ORGANIZATION | OTHER | OUTPUT | OVERFLOW | OVERLINE | OWN | PACKED_DECIMAL | PADDING | PAGE | PAGE_COUNTER | PASSWORD | PERFORM | PF | PH | PIC | PICTURE | PLUS | POINTER | POSITION | POSITIVE | PORT | PRINTER | PRINTING | PRIVATE | PROCEDURE | PROCEDURE_POINTER | PROCEDURES | PROCEED | PROCESS | PROGRAM | PROGRAM_ID | PROGRAM_LIBRARY | PROMPT | PURGE | QUEUE | QUOTE | QUOTES | RANDOM | READER | REMOTE | RD | REAL | READ | READYTRACE | RECEIVE | RECEIVED | RECORD | RECORDING | RECORDS | RECURSIVE | REDEFINES | REEL | REF | REFERENCE | REFERENCES | RELATIVE | RELEASE | REMAINDER | REMARKS | REMOVAL | REMOVE | RENAMES | REPLACE | REPLACING | REPORT | REPORTING | REPORTS | REQUIRED | RERUN | RESERVE | REVERSE_VIDEO | RESET | RESETTRACE | RETURN | RETURN_CODE | RETURNING| REVERSED | REWIND | REWRITE | RF | RH | RIGHT | ROUNDED | RUN | SAME | SAVE | SCREEN | SD | SEARCH | SECTION | SECURE | SECURITY | SEGMENT | SEGMENT_LIMIT | SELECT | SEND | SENTENCE | SEPARATE | SEQUENCE | SEQUENTIAL | SERVICE | SERVICELABEL | SERVICERELOAD | SET | SHARED | SHAREDBYALL | SHAREDBYRUNUNIT | SHARING | SHIFT_IN | SHIFT_OUT | SHORT_DATE | SIGN | SIZE | SKIP1 | SKIP2 | SKIP3 | SORT | SORT_CONTROL | SORT_CORE_SIZE | SORT_FILE_SIZE | SORT_MERGE | SORT_MESSAGE | SORT_MODE_SIZE | SORT_RETURN | SOURCE | SOURCE_COMPUTER | SPACE | SPACES | SPECIAL_NAMES | SQL | STANDARD | STANDARD_1 | STANDARD_2 | START | STATUS | STOP | STRING | SUB_QUEUE_1 | SUB_QUEUE_2 | SUB_QUEUE_3 | SUBTRACT | SUM | SUPPRESS | SYMBOL | SYMBOLIC | SYNC | SYNCHRONIZED | TABLE | TALLY | TALLYING | TASK | TAPE | TERMINAL | TERMINATE | TEST | TEXT | THAN | THEN | THREAD | THREAD_LOCAL | THROUGH | THRU | TIME | TIMER | TIMES | TITLE | TO | TODAYS_DATE | TODAYS_NAME | TOP | TRAILING | TRUE | TRUNCATED | TYPE | TYPEDEF | UNDERLINE | UNIT | UNSTRING | UNTIL | UP | UPON | USAGE | USE | USING | VALUE | VALUES | VARYING | VIRTUAL | WAIT | WEBSERVICE | WHEN | WHEN_COMPILED | WITH | WORDS | WORKING_STORAGE | WRITE | XCTL | YEAR | YYYYMMDD | YYYYDDD | ZERO | ZERO_FILL | ZEROS | ZEROES | AMPCHAR | ASTERISKCHAR | DOUBLEASTERISKCHAR | COLONCHAR | COMMACHAR | COMMENTENTRYTAG | COMMENTTAG | DOLLARCHAR | DOUBLEQUOTE | DOT_FS | DOT | EQUALCHAR | EXECCICSTAG | EXECSQLTAG | EXECSQLIMSTAG | LESSTHANCHAR | LESSTHANOREQUAL | LPARENCHAR | MINUSCHAR | MORETHANCHAR | MORETHANOREQUAL | NOTEQUALCHAR | PLUSCHAR | SINGLEQUOTE | RPARENCHAR | SLASHCHAR
   ;
*/
