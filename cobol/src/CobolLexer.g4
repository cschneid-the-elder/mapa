...
// added {getCharPositionInLine() == 6}? to CLASSIC_LINE_NUMBER and removed BOL
...
*/
/*
NIST_SEMI_COMMENT_A : BOL TEXTA TEXTA TEXTA TEXTA TEXTA TEXTA A TEXTA* {getCharPositionInLine() < 73}? -> skip;
NIST_SEMI_COMMENT_B : BOL TEXTA TEXTA TEXTA TEXTA TEXTA TEXTA B TEXTA* {getCharPositionInLine() < 73}? -> skip;
NIST_SEMI_COMMENT_C : BOL TEXTA TEXTA TEXTA TEXTA TEXTA TEXTA C TEXTA* {getCharPositionInLine() < 73}? -> skip;
...
NIST_SEMI_COMMENT_P : BOL TEXTA TEXTA TEXTA TEXTA TEXTA TEXTA P TEXTA* {getCharPositionInLine() < 73}? -> skip;
NIST_SEMI_COMMENT_S : BOL TEXTA TEXTA TEXTA TEXTA TEXTA TEXTA S TEXTA* {getCharPositionInLine() < 73}? -> skip;
NIST_SEMI_COMMENT_T : BOL TEXTA TEXTA TEXTA TEXTA TEXTA TEXTA T TEXTA* {getCharPositionInLine() < 73}? -> skip;
NIST_SEMI_COMMENT_U : BOL TEXTA TEXTA TEXTA TEXTA TEXTA TEXTA U TEXTA* {getCharPositionInLine() < 73}? -> skip;
NIST_SEMI_COMMENT_X : BOL TEXTA TEXTA TEXTA TEXTA TEXTA TEXTA X TEXTA* {getCharPositionInLine() < 73}? -> skip;
NIST_SEMI_COMMENT_Y : BOL TEXTA TEXTA TEXTA TEXTA TEXTA TEXTA Y TEXTA* {getCharPositionInLine() < 73}? -> skip;
...
NIST_SEMI_COMMENT_G : BOL TEXTA TEXTA TEXTA TEXTA TEXTA TEXTA G {getCharPositionInLine() == 7}? -> skip;
NIST_SEMI_COMMENT_J : BOL TEXTA TEXTA TEXTA TEXTA TEXTA TEXTA J {getCharPositionInLine() == 7}? -> skip;
...
//CLASSIC_EOL_COMMENT : TEXTA TEXTA TEXTA TEXTA TEXTA TEXTA TEXTA TEXTA {System.out.println(getLine() + ":" + getCharPositionInLine() + " /" + getText() + "/");} ;
...
/*
AUTHOR_TAG : AUTHOR {getCharPositionInLine() == 13}?;
INSTALLATION_TAG : INSTALLATION {getCharPositionInLine() == 19}?;
DATE_WRITTEN_TAG : DATE_WRITTEN {getCharPositionInLine() == 19}?;
DATE_COMPILED_TAG : DATE_COMPILED {getCharPositionInLine() == 20}?;
SECURITY_TAG : SECURITY {getCharPositionInLine() == 15}?;
REMARKS_TAG : REMARKS {getCharPositionInLine() == 14}?;
...
//CONTINUED_NONNUMERIC_LITERAL : CONTINUED_STRINGLITERAL; //MATCHES AS FAR AS IT GOES...
//CONTINUED_NONNUMERIC_LITERAL : CONTINUED_STRINGLITERAL CLASSIC_EOL_COMMENT CLASSIC_CONTINUATION WS* NONNUMERICLITERAL; //works for specific case @932 in EXEC85
//CONTINUED_NONNUMERIC_LITERAL : CONTINUED_STRINGLITERAL CLASSIC_CONTINUATION WS* NONNUMERICLITERAL; //NO
//CONTINUED_NONNUMERIC_LITERAL : CONTINUED_STRINGLITERAL | CONTINUED_DBCSLITERAL | CONTINUED_HEXNUMBER  | CONTINUED_NULLTERMINATED CLASSIC_CONTINUATION NONNUMERICLITERAL; // ALMOST WORKS
//CONTINUED_NONNUMERIC_LITERAL : CONTINUED_DBCSLITERAL | CONTINUED_HEXNUMBER  | CONTINUED_NULLTERMINATED | CONTINUED_STRINGLITERAL CLASSIC_CONTINUATION NONNUMERICLITERAL; // NO
