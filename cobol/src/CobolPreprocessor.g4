...
charDataKeyword
   ...
   | DATA | DATEPROC | DBCS | DD | DEBUG | DEC | DECK | DEFINE | DEF | DIAGTRUNC | DISPSIGN | DLI | DLL | DP | DS | DSN | DSNAME | DTR | DU | DUMP | DYN | DYNAM | DWARF
   ...
   | PAC | PARMCHECK | PATH | PFD | PGMN | PGMNAME | PPTDBG | PRESERVE | PROCESS | PROLOG
   | QUALIFY | QUA | QUOTE
   | RENT | REPLACING | RMODE | RULES
   | SEQ | SEQUENCE | SEP | SEPARATE | SERV | SERVICE | SHORT | SIZE | SLACKBYTES | SLCKB | SO | SOURCE | SP | SPACE | SPIE | SQL | SQLC | SQLCCSID | SQLIMS | SS | SSR | SSRANGE | STD | STANDARD | STGOPT | STRICT | SUCC | SUPP | SUPPRESS | SYSEIB | SZ
