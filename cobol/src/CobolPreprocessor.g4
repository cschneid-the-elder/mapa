...
compilerOption
   ...
   | (COMPILE | C_CHAR) 
   | ((COPYLOC | CPLC) LPARENCHAR literal (COMMACHAR DSN LPARENCHAR literal RPARENCHAR)? (COMMACHAR PATH LPARENCHAR literal RPARENCHAR)? RPARENCHAR)
   ...
   | NOZWB
   | (NUMBER | NUM)
   | ((NUMCHECK | NC) (LPARENCHAR (ZON (LPARENCHAR (ALPHNUM | NOALPHNUM) RPARENCHAR)? | NOZON) (COMMACHAR? (PAC | NOPAC))? (COMMACHAR? (BIN | NOBIN))? (COMMACHAR? (MSG | ABD))? RPARENCHAR)?)
...
charDataKeyword
   ...
   | CBL | CBLCARD | CO | COBOL2 | COBOL3 | CODEPAGE | COMMACHAR | COMPAT | COMPILE | COPYLOC | COPYRIGHT | CP | CPLC | CPP | CPSM | CPYR | CS | CURR | CURRENCY
   | DATA | DATEPROC | DBCS | DD | DEBUG | DEC | DECK | DEFINE | DEF | DIAGTRUNC | DISPSIGN | DLI | DLL | DP | DS | DSN | DSNAME | DTR | DU | DUMP | DWARF | DYN | DYNAM
   ...
   | NOD | NODATEPROC | NODBCS | NODE | NODEBUG | NODECK | NODEFINE | NODEF | NODIAGTRUNC | NODLL | NODSNAME | NODU | NODUMP | NODP | NODTR | NODWARF | NODYN | NODYNAM
   | NOEDF | NOEJPD | NOENDPERIOD | NOEPILOG | NOEVENPACK | NOEXIT | NOEXP | NOEXPORTALL
   ...
   | NORENT | NORULES
   | NOS | NOSEP | NOSEPARATE | NOSEQ | NOSEQUENCE | NOSERVICE | NOSLACKBYTES | NOSOURCE | NOSPIE | NOSQL | NOSQLC | NOSQLCCSID | NOSQLIMS | NOSSR | NOSSRANGE | NOSTDTRUNC | NOSTGOPT | NOSUPP | NOSUPPRESS
   ...
   | SEQ | SEQUENCE | SEP | SEPARATE | SERVICE | SHORT | SIZE | SLACKBYTES | SLCKB | SOURCE | SP | SPACE | SPIE | SQL | SQLC | SQLCCSID | SQLIMS | SS | SSR | SSRANGE | STD | STGOPT | SUCC | SUPP | SUPPRESS | SYSEIB | SZ
