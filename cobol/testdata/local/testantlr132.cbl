...
000022     
000023     JSON GENERATE WS-BUF FROM SOME-DATA END-JSON
000024
000025     JSON GENERATE
...
000035     END-JSON
000036
000037     JSON GENERATE
000038         WS-BUF FROM SOME-DATA
000039         COUNT IN WS-COUNT
000040         NAME OF SD-001 IS 'ARTHUR'
000041                 SD-002 IS 'DENT'
