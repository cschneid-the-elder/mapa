...
dsnutilUCSBackup
	...
	dsnutilReplicationCopyOption?
	;

dsnutilReplicationCopyOption
	: (
	DSNUTIL_FORCE 
	| (DSNUTIL_DUMP dsnutilDumpclassSpec? DSNUTIL_FORCE?) 
	| (DSNUTIL_DUMPONLY (DSNUTIL_TOKEN DSNUTIL_LPAREN dsnutilUCSArg DSNUTIL_RPAREN)? dsnutilDumpclassSpec?)
	)
	;
	
dsnutilDumpclassSpec
	: (DSNUTIL_DUMPCLASS DSNUTIL_LPAREN dsnutilUCSArg (DSNUTIL_COMMA dsnutilUCSArg)* DSNUTIL_RPAREN)
	;
